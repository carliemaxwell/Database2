...
VALUES (2, 2, 'Diane Cilento'),
	(3, 3, 'Jackie Sandler');

INSERT INTO Actor (aid, Address, birthDate, hairColor, eyeColor, height, weight, favColor, anniversary)
VALUES (2, '123 Bond Dr','August 25, 1930', 'brown', 'brown', 68,170, 'blue', 'October 10, 2016' ),
	(3, '45 Light Lane', 'September 9, 1966', 'brown', 'brown', 69, 180, 'green', 'October 10, 2016' );
...
VALUES (5, 'Across the Universe', 2007, 400, 345000, 500000, 300000),
	(2, 'James Bond', 1980, 300, 400000, 500000, 200000);
...
lensMaker)
VALUES (2, 'Terence Young', '23 Director Dr.', 'Sabine Sun', 'Shanghai', '2004', 'Sigma'),
	(10, 'JJ Abrams', '20 Lost Lane', 'Katie McGrath', 'Sarah Lawrence', '2007', 'Sigma'),
	(5, 'Julie Taymor', '15 Strawberry Field' , 'Elliot Goldenthal', 'Oberlin College', '2003', 'sigma');
